...
# --- واجهة المشترك الأساسية (نظيفة وخالية من أوامر الأدمن) ---
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # الواجهة أصبحت مخصصة للزبون فقط (بدون أي أزرار تخص الأكواد أو الأدمن)
    keyboard = [
...
def main():
    ...
    print("🚀 البوت يعمل الآن بنظام الواجهة النظيفة للزبون وصلاحيات الإدارة المخفية!")
    app.run_polling()
